...
def extrair_dados_municipios():
    ...
    dir_saida = os.path.join(dir_base, 'Dados_munic_2022')
    ...
    for i, cod_ibge in enumerate(codigos_ibge, 1):
        ...
        for me_referencia in range(1, 13):
            params = {
                'id_ente': cod_ibge,
            ...
            try:
                ...
                if 'items' in dados and dados['items']:
                    ...
                    df_mes = df_mes[
                        ...
                        df_mes['natureza_receita'].astype(str).str.startswith('1713')
                    ]
        ...
        if dados_consolidados:
            ...
            nome_arquivo = f"dados_tesouro_{cod_ibge}_{an_referencia}.csv"
...
if __name__ == "__main__":
    ...
    try:
        ...
        if sucesso:
            ...
            print("- Arquivos salvos em: Dados_munic_2022")
        else:
